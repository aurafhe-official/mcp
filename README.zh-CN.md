...
| 体验 Aura 的三种方式 | 入口 |
| --- | --- |
| **1. 体验 Aura AI**：业务问题与追问 | [aura.afhe.io](https://aura.afhe.io) · [访问状态与演示指南](docs/AI-DEMO.md) |
| **2. 评估应用**：加密数据库、通讯或私有推理 | 联系 **gen@afhe.io** |
| **3. 通过 MCP 连接助手**：数值工具与可选课程 | [安装步骤](docs/QUICKSTART.md) |
...
当前版本 **0.5.0-rc.8**，固定安装可使用 `@aurafhe/mcp@0.5.0-rc.8`。
...
助手先解释应用和官网基准，再区分 AI 体验、应用评估与 MCP 连接。
MCP 内可选择公开样例课程或开发工具。
