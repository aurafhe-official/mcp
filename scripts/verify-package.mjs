...
const allowed = /^(?:package\.json|release-status\.json|README\.md|README\.zh-CN\.md|SECURITY\.md|LICENSE|dist\/(?:index|server|contracts|fhe|guide|coprocessor|artifacts)\.(?:js|d\.ts)|docs\/(?:ARCHITECTURE|PROTOCOL|QUICKSTART|SECURITY-MODEL|VERIFICATION|INVESTOR-DEMO|AI-DEMO|EXPERIENCES)\.md)$/
